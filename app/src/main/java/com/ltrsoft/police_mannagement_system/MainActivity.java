...
import com.ltrsoft.police_mannagement_system.Fragment.analys.TotalACP;
...
//        AcpanalyticalDashboardFragment acpanalyticalDashboardFragment=new AcpanalyticalDashboardFragment();
        getSupportFragmentManager().beginTransaction().add(R.id.main_container, new TotalACP()).commit();
