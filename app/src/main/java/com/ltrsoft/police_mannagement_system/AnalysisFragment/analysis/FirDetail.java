...
public class FirDetail extends Fragment {
    ...
    private TextView FIRNo, Internal_IO, unit_name, Offence_From_Date,
            Offence_To_Date, FIR_Type, FIR_Stage, Complaint_Mode, CrimeGroup_Name,
            CrimeHead, ActSection,
            IOName, Place_of_Offence, Beat_Name, Village_Area_Name, Unit_ID;
    private View view;
    String FIR_ID;
    String Unit_IDs;
